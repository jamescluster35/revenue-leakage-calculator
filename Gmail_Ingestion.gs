    ...
    const replyHtml = 
      `<div style="font-family: Arial, sans-serif; max-width: 600px; color: #1E293B; font-size: 14px; line-height: 1.6;">` +
        ...
        `<div style="margin: 24px 0;">` +
          `<a href="https://bdl.dataconnectmail.com" style="display: inline-block; background-color: #F97316; color: #ffffff; text-decoration: none; padding: 14px 28px; border-radius: 8px; font-weight: bold; font-size: 15px; box-shadow: 0 4px 6px rgba(249,115,22,0.2);">` +
