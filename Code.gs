            ...
            <table width="600" cellpadding="0" cellspacing="0" border="0" style="width: 100%; max-width: 600px; margin: 0 auto;">
              <tr>
                <td style="background-color: #141720; padding: 30px; border-radius: 12px; border: 1px solid #1E2230;">
                  ...
                  <p style="font-size: 14px; line-height: 1.6; color: #E8EAF0; margin-bottom: 25px;">
                    We want to help you plug these gaps. We have generated an interactive portal for your business detailing your exact recovery roadmap and action steps. Access your portal now to begin tracking.
                  </p>
                  
                  <div style="text-align: center; margin-bottom: 25px;">
                    <a href="https://bdl.dataconnectmail.com/dashboard.html?id=${lead.id}" style="display: inline-block; background-color: #10B981; color: #ffffff; text-decoration: none; padding: 12px 24px; border-radius: 6px; font-weight: bold; font-size: 14px; text-transform: uppercase;">Access Recovery Portal</a>
                  </div>

                  <p style="color: #9CA3AF; font-size: 12px; line-height: 1.6; margin: 0;">
                    Best regards,<br>
                    <strong>BDL Revenue Intelligence Team</strong><br>
                    <a href="mailto:jamescluster35@gmail.com" style="color: #F97316; text-decoration: none;">jamescluster35@gmail.com</a>
                  </p>
                </td>
              </tr>
            </table>
            ...
            <table width="600" cellpadding="0" cellspacing="0" border="0" style="width: 100%; max-width: 600px; margin: 0 auto;">
              <tr>
                <td style="background-color: #141720; padding: 30px; border-radius: 12px; border: 1px solid #1E2230;">
                  ...
                  <p style="font-size: 14px; line-height: 1.6; color: #E8EAF0; margin-bottom: 25px;">
                    Whether it's scheduling optimization, claim rejection audits, or automated follow-up drips, we make recovery simple. Log into your interactive dashboard to track your 90-day progress.
                  </p>
