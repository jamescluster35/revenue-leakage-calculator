...
function buildFullPdfReportHtml(lead, note) {
  ...
  return `<!DOCTYPE html><html>
    ...
    <body>
      ...
      <div class="page-break"></div>
      <div style="padding:32px 24px;">
        <h2 style="color:#0F172A; text-transform:uppercase; font-size:14px; border-bottom:2px solid #E2E8F0; padding-bottom:8px; margin-bottom: 24px; letter-spacing: 1px;">Appendix A: Diagnostic Methodology</h2>
        <p style="font-size: 13px; color: #475569; line-height: 1.7; margin-bottom: 20px;">
          The BDL Revenue Intelligence Engine utilizes a proprietary algorithmic model to identify, quantify, and map revenue leakage across service-based operations. 
          By analyzing over 10,000 data points across multiple industry verticals, our system establishes a baseline performance standard known as the "Maximum Capture Potential" (MCP).
        </p>
        <p style="font-size: 13px; color: #475569; line-height: 1.7; margin-bottom: 20px;">
          The calculations provided in this diagnostic are derived by comparing your self-reported operational metrics against the MCP for the <strong>${esc(niche.charAt(0).toUpperCase() + niche.slice(1))}</strong> sector. The variance between your current operations and the MCP represents your total recoverable revenue.
        </p>
        
        <h3 style="color:#1E293B; font-size: 15px; margin-top: 40px; margin-bottom: 16px;">Primary Leakage Vectors</h3>
      ...
      <div style="padding:32px 24px;">
        ...
        <p style="font-size: 11px; color: #94A3B8; line-height: 1.6; font-style: italic;">
          Data compiled from BDL Intelligence aggregates. Businesses failing to meet the "Average" threshold are considered highly vulnerable to market contraction.
        </p>
      </div>
